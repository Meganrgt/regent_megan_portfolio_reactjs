        ...
        <div>
            ...
            <main>
                <div className="row">
                    ...
                    <ServiceBlock icon="bi bi-code-slash" title="Développement web" description="Le développement de sites web consiste à créer des sites internet en utilisant des langages de programmation (HTML, CSS, Javascript, PHP etc.) et des frameworks (Bootstrap, React, Angular etc.)." />
                    <ServiceBlock icon="bi bi-search" title="Référencement" description="Le référencement naturel (SEO) est une technique qui consiste à optimiser un site web pour le faire remonter dans les résultats des moteurs de recherche (Google, Bing, Yahoo etc.). L'objectif est d'attirer un maximum de visiteurs qualifiés sur ce site." />
                </div>
            </main>
        </div>
    )
